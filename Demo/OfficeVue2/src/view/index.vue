			...
			SendUpdateJson() {
				...
				let msg = {
					...
					"para":{
						...
						"Date": "2026-05-06",
						"Desc": "1、中间件解决Chrome及Edge等浏览器升级到147及以上版本时前端无法连接到中间件端口问题；2、解决Office网页组件设置禁止打印等权限在部分情况下无效问题；3、解决WPS网页组件Windows 11下高版本谷歌等浏览器上禁止复制内容出其它软件非全屏窗口失效问题，解决把最新WPS专业版识别为个人版问题；4、解决Office、CAD及OCX等网页组件在调用自动化接口设置带参数的属性时可能错误问题题...",
