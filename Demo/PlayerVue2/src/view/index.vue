				...
				let msg = {
					...
					"para":{
						"Name":"PageHiPlayer—RTSP多引擎低延迟网页播放器升级包",
	  					"Date":"2024-08-26",
						"Desc":"1、中间件高级版解决在释放已启动的内嵌网页小程序同时启动新的小程序可能失败问题；2、优化中间件从Url中解析文件名算法，解决部分Url地址格式问题导致的文档下载失败问题；3、PageHiPalyer解决禁用播放工具栏菜单失效问题，解决多引擎网页播放器使用FFPlay引擎播放时锁屏再解锁崩溃问题置...",
