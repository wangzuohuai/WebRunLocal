...
const player = ref()
let version = ref('2.2.16.9') //中间件版本信息
...
function SendUpdateJson() {
  ...
  let msg = {
    ...
    "para":{
		...
		"Date":"2024-12-09",
		"Desc":"1、优化中间件高级版浏览器兼容处理，解决个别电脑再次启动内嵌小程序可能失败问题，解决下载升级包时多线程配置无效问题；2、PageHiPlayer的VLC引擎播放支持分流器设置，解决多引擎使用VLC引擎播放时TCP连接设置无效导致播放慢问题，解决播放测试程序不支持长地址问题程...",
