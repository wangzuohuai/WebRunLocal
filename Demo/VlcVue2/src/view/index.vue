		...
		methods: 
		{
			...
			openWebsocket(port,type) {
				...
				socketClient.onError = (msg) => {
					...
					{
						//连接不上，认为还没有安装PageHiPlayer—VLC低延迟网页播放器 没有安装时提示安装
						this.$confirm('PageHiPlayer—VLC低延迟网页播放器 服务端口连接失败，可能是尚未安装，是否马上下载安装？', '提示', {
							confirmButtonText: '确定',
							cancelButtonText: '取消',
							type: 'warning'
						}).then(() => {
			...
			SendUpdateJson() {
				...
				let msg = {
					...
					"para":{
						...
						"Date":"2025-05-06",
						"Desc":"1、新增支持请求本机已安装软件信息列表；2、升级高级版内嵌小程序抓图功能，可支持多次框选区域抓图，支持全屏播放时即时抓图操作，解决部分系统抓图效果有白边问题；3、改进高级版内嵌小程序连续滚动操作及改变显示位置等实现，要求请求的rid自增解决操作结束时位置错乱问题，提供滚动结束通知给前端；4、解决高级版个别情况下启动内嵌小程序释放后再启动时消息窗口句柄无效引发的启动失败问题；5、PageHiPlayer播放器分屏样式支持通过透明网页叠加实现个性化效果，解决在非播放网页点击同一个浏览器网页自动切换窗口问题...",
						"DownAddr":"http://local.zorrosoft.com/Files/Update/RTSP_Update.pid",
						"Open":"http://local.zorrosoft.com/VLC",
						"MD5":"75FAADE88985A12FD3A164985AB3D6FB",
						"Version":"2.2.17.5",
						"Size":38109184,
						"HideIns":0,
						"Cookie":"",
						"Auth":"",
						"TK":""
					}
				}
				this.socket[0].sendObj(msg)
			}
