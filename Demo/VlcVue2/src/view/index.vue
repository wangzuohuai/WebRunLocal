			...
			SendUpdateJson() {
				...
				let msg = {
					...
					"para":{
						...
						"Date":"2024-09-26",
						"Desc":"1、中间件水印版服务WS连接TK校验时有效期修改为不能超过30天，优化高级版内嵌小程序启动稳定性，改进非系统服务方式运行启动时要求管理员权限的时机；2、中间件解决下载0字节大小文件问题，优化下载时临时文件名生成算法，避免过长文件名导致错误，上传文件时请求地址增加PHPostSize和PHPostMD5两个参数，接收方可提前获取数据包大小和MD5哈希值；3、解决中间件服务进程异常崩溃后服务启动后加载内嵌小程序可能失败问题，异常重启后小程序编号不重新计数，解决内嵌小程序启动可能偶尔卡死问题，解决上一版引入的系统hosts文件内容丢失数据问题；4、PageHiPlayer在多路播放时，增加自动顺序播放的支持，避免多路同时初始化播放引擎可能卡顿现象...",
						"DownAddr":"http://local.zorrosoft.com/Files/Update/RTSP_Update.pid",
						"Open":"http://local.zorrosoft.com/VLC",
						"MD5":"EFFAA579C70ED8B8877B834A9251CD40",
						"Version":"2.2.16.6",
						"Size":43909120,
						"HideIns":0,
						"Cookie":"",
						"Auth":"",
						"TK":""
					}
				}
				this.socket[0].sendObj(msg)
			}
