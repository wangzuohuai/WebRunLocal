			...
			SendUpdateJson() {
				...
				let msg = {
					...
					"para":{
						...
						"Date":"2024-05-09",
						"Desc":"1、中间件实现多线程下载和文件异步上传功能；2、解决高级版内嵌网页小程序启动偶尔卡死等问题；3、PageHiPlayer中VLC引擎录像当前正在播放的视频时，支持从当前画面开始，另外可通过配置实现更多播放日志输出；4、PageHiPlayer的VLC引擎支持异步播放及连接超时设置，解决可能因为播放地址错误导致的界面卡顿问题...",
						"DownAddr":"http://local.zorrosoft.com/Files/Update/RTSP_Update.pid",
						"Open":"http://local.zorrosoft.com/VLC",
						"MD5":"CFA84F531C0A020FDC74767489D67D4D",
						"Version":"2.2.15.1",
						"Size":66060288,
						"HideIns":0,
						"Cookie":"",
						"Auth":"",
						"TK":""
					}
				}
				this.socket[0].sendObj(msg)
			}
