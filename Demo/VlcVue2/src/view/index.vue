			...
			SendUpdateJson() {
				...
				let msg = {
					...
					"para":{
						...
						"Date":"2026-05-06",
						"Desc":"1、中间件网络库HTTPS上传时强制使用TLS 1.2协议，解决Chrome及Edge等浏览器升级到147及以上版本时前端无法连接到中间件端口问题；2、解决高级版内嵌网页小程序在个别情况下显示大小问题及在移动浏览器的窗口或切换窗口时焦点失效问题...",
						"DownAddr":"http://local.zorrosoft.com/Files/Update/RTSP_Update.pid",
						"Open":"http://local.zorrosoft.com/VLC",
						"MD5":"C86A62CBAF2C499CCEFF97C91C0CB40E",
						"Version":"2.2.17.11",
						"Size":28508160,
						"HideIns":0,
						"Cookie":"",
						"Auth":"",
						"TK":""
					}
				}
				this.socket[0].sendObj(msg)
			}
