...
let version = ref('2.2.16.1')   //中间件版本信息
  ...
  let msg = {
    ...
    "para":{
      "Name": "PageHiOffice—文档在线编辑组件升级包",
			"Date": "2024-07-05",
			"Desc": "1、优化中间件服务进程定时过程实现，降低CPU使用率，WS传递二进制流数据时支持大文件，建议所有的小程序基于最新版支持库替换开发范例中公用代码重新编译后发布；2、PageHiOffice支持接收前端发来的字节流文件并打开，保存支持字节流数据文件传递到前端，插入图片时支持指定插入位置参数，此外内容转换图片支持是否自动裁剪设置...",
			"DownAddr": "http://local.zorrosoft.com/Files/Update/Office_Update.pid",
			"Open": "http://local.zorrosoft.com/office3",
			"MD5": "934094BEDAC62863966A2E130E540339",
			"Version": "2.2.16.1",
			"Size": 31031296,
			"HideIns": 0,
			"Cookie": "",
			"Auth": "",
			"TK": ""
    }
  }
  socket[0].sendObj(msg)
}
