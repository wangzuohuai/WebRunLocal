...
const player = ref()
let version = ref('2.2.13.1') //中间件版本信息
...
function SendUpdateJson() {
  ...
  let msg = {
    ...
    "rid":rid,
    "para":{
    	"Name":"PageHi-VLC网页播放器升级包",
		"Date":"2024-02-27",
		"Desc":"1、中间件及相关小程序发布海外版，支持360安全浏览器64位版；2、网络版服务管理器终端用户信息导出支持txt格式，解决授权服务器不同于默认授权方式授权到期处理问题；3、优化中间件高级版小程序嵌入网页后焦点处理；4、解决个别情况下加载了高级版内嵌网页小程序窗口无法最小化显示等问题...",
		"DownAddr":"http://local.zorrosoft.com/Files/Update/RTSP_Update.pid",
		"Open":"http://local.zorrosoft.com/VLC",
		"MD5":"59FBC9AC0FC3F362575DE683EE47732B",
		"Version":"2.2.13.1",
		"Size":44007424,
		"HideIns":0,
		"Cookie":"",
		"Auth":"",
		"TK":""
    }
  }
  socket[0].sendObj(msg)
}
