    ...
    sendUpdateJson() {
        ...
        let msg = {
            ...
            "para": {
                ...
                "Date": "2026-05-06",
                "Desc": "1、中间件网络库HTTPS上传时强制使用TLS 1.2协议，解决Chrome及Edge等浏览器升级到147及以上版本时前端无法连接到中间件端口问题；2、解决高级版内嵌网页小程序在个别情况下显示大小问题及在移动浏览器的窗口或切换窗口时焦点失效问题；3、解决CAD网页组件在调用自动化接口设置带参数的属性时可能错误问题...",
                "DownAddr": "http://local.zorrosoft.com/Files/Update/CAD_Update.pid",
                "Open": "http://local.zorrosoft.com/CADJS",
                "MD5": "CA12C72B8C193D5F92E6307845F5D4BF",
                "Version": "2.2.17.11",
                "Size": 27623424,
                "HideIns": 0,
                "Cookie": "",
                "Auth": "",
                "TK": ""
            }
        }
        this.ws.sendMessage(msg)
    }
