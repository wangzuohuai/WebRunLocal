...
const remote_wss = 'wss://wrl.zorrosoft.com'
...
class websocket {
    ...
    getDefaultConn(port='',type=0) {
        ...
        if (Protocol.toUpperCase().indexOf('HTTPS') > -1)
        {
            ...
            if(1 == type)
                return remote_wss+':'+port+'?sid=' + this.getRandom(5).toLocaleString() + '&flag=1&cid='+cid+'&tk='; // 这里注意test.yuanmaster.com替换为自己的子域名
            else
                return remote_wss+':'+port+'?sid=' + this.getRandom(5).toLocaleString() + '&flag='+flag; // 这里注意wrl.zorrosoft.com替换为自己的子域名
        }
        else
        {
            port = port=='' ?83:port
